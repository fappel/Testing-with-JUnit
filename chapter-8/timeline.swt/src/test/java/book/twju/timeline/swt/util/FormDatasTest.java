package book.twju.timeline.swt.util;

import static book.twju.timeline.swt.util.FormDatas.DENOMINATOR;
import static book.twju.timeline.swt.util.FormDatas.attach;
import static book.twju.timeline.swt.util.FormDatasAssert.assertThat;
