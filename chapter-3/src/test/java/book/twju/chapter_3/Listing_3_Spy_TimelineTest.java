...
public class Listing_3_Spy_TimelineTest {
  ...
  private SessionStorageSpy sessionStorage;
  ...
  public void setUp() {
    ...
    sessionStorage = new SessionStorageSpy();
  ...
  public void fetchFirstItems() {
    ...
    assertEquals( 1, sessionStorage.getLog().size() );
    assertSame( SECOND_ITEM, sessionStorage.getLog().get( 0 ) );
