...
<tr><td width="250px" style="border:none;">
...
<td width="380px" style="border:none;">
...
<tr><td width="270px" style="border:none;">
...
<p>Note that the sample is not production ready, using splash screens or the like on startup. In fact the first launch will take some time, as it clones the <a href="https://github.com/junit-team/junit" target="_blank">JUnit Git Repository</a>, since it uses the commits as timeline content.</p>
</td></tr>
<table>
